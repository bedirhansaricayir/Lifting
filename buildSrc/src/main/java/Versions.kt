object Versions {
    ...
    const val platformComposeBomTestVersion = "2022.10.00"
    ...
    //Numberpicker
    const val numberpickerVersion = "1.0.3"

    //FirebaseBOM
    const val platformFirebaseBomVersion = "32.1.1"

    //Google Auth
    const val googleServicesAuthVersion = "20.6.0"
